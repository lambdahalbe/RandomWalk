...
<<<<<<< HEAD
P = perm(triangular_walker(np.zeros((2), dtype=int), self_avoiding = True, scaling_factor = 2), 1000, 10000, metadata_filename="triangular_meta.txt")
=======
...
>>>>>>> 563cdac863c012d1cbb962cd01822a182f23af13
